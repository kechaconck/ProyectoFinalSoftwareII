...
<div class="container mt-3">
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#agregarProducto">Agregar Producto</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#listaProductos">Lista de Productos</a>
        </li>
    </ul>

    <div class="tab-content">
        <div id="agregarProducto" class="tab-pane fade show active">
        ...
        <div id="listaProductos" class="tab-pane fade">
