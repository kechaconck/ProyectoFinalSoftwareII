        ...
        if  (menu.equals("Clientes")) {
            ...
            switch (accion) {
                ...
                case "Actualizar":
                    ...
                    String rolUpdate = request.getParameter("txtrol");
                    String estadoUpdate = request.getParameter("txtestado");
                    usuario2.setDocumento(documentoUpdate);
                    usuario2.setNombre(nombreUpdate);
                    usuario2.setPassword(passwordUpdate);
                    usuario2.setCorreo(correoUpdate);
                    usuario2.setRol(rolUpdate);
                    usuario2.setEstado(estadoUpdate);
